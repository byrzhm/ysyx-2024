...
//  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R    , R(rd) = src1 / src2 /* TODO */                          );
//  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R    , R(rd) = src1 % src2 /* TODO */                          );
//  INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R    , R(rd) = src1 % src2 /* TODO */                          );
