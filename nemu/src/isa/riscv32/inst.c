...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 001 ????? 11000 11", bne    , B    , if (src1 != src2) s->dnpc = src1 + imm                    );
...
//INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R    , /* TODO */                                                );
//INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R    , /* TODO */                                                );
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu  , R    , R(rd) = ((uint64_t)src1 * (uint64_t)src2) >> 32           );
//  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R    , R(rd) = a / b /* TODO */                                );
//  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R    , R(rd) = a / b /* TODO */                                );
//  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R    , R(rd) = a % b /* TODO */                                );
//  INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R    , R(rd) = a % b /* TODO */                                );
...
int isa_exec_once(Decode *s) {
  s->isa.inst.val = inst_fetch(&s->snpc, 4); // s->snpc will be pc + 4
